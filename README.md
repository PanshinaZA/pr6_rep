...
Для выполнения задания необходимо вывести `zip_code`, количество клиентов(уникальных, потому используем `DISTINCT`), среднее количество транзакций(количество продаж на количество клиентов), средний объем продаж и процент использования общественного транспорта. Опять же таки свяжем таблицы так же, как в прошлом задании. Кроме того, учитываем только те данные, где процент использования общественного транспорта больше 0.

![image](https://github.com/user-attachments/assets/7ff75f2d-d9f6-4f8f-8ca8-9ac729d01502)
...
`pr6.ipynb` — Jupyter Notebook с выполнением всех заданий, файл находится в репозитории.
